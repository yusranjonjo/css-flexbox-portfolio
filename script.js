...
const li1 = document.querySelector('.navbar ul li:nth-child(1)');
const li2 = document.querySelector('.navbar ul li:nth-child(2)');
const li3 = document.querySelector('.navbar ul li:nth-child(3)');
